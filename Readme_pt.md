...
### Detalhes
        ...
        Para alterar as referências de uma camada, editamos dentro do método 'References()' e adicionamos:
        
        RefencesTo("reference_project")

        Após a configuração de estrutura, dependências e referências dentro do arquivo da camada, prosseguimos conforme o exemplo:
